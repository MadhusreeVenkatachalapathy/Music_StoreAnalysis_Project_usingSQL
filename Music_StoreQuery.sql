...
SELECT customer.customer_id, customer.first_name, customer.last_name , SUM(invoice.total) as Total_spending FROM music_database.customer 
...
SELECT customer.customer_id,  SUM(invoice.total) as Total_spending FROM music_database.customer 
JOIN music_database.invoice ON customer.customer_id = invoice.customer_id
...
-- customer name, artist name and total spent # used CTE syntax
